...
import 'package:flutter_dmzj/views/user/user_drawer.dart';
...
class _MyHomePageState extends State<MyHomePage>
  ...
  List<Widget> pages = [ComicHomePage(),Container(),Container()];
  int _index = 0;
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: <BottomNavigationBarItem>[
          BottomNavigationBarItem(
              title: Text("漫画"), icon: Icon(Icons.library_books)),
          BottomNavigationBarItem(
              title: Text("新闻"), icon: Icon(Icons.whatshot)),
          BottomNavigationBarItem(title: Text("轻小说"), icon: Icon(Icons.book)),
        ],
      ),
      body: IndexedStack(
        index: _index,
