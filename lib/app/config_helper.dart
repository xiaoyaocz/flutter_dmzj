...
class ConfigHelper{
  ...
  static UserInfo getUserInfo(){
    ...
    return (userInfoString!=null&&userInfoString.length!=0)?UserInfo.fromJson(jsonDecode(userInfoString)):null;
  }
  ...
  static UserProfileModel getUserProfile(){
    ...
    return (userInfoString!=null&&userInfoString.length!=0)?UserProfileModel.fromJson(jsonDecode(userInfoString)):null;
  }
  ...
  static int getComicHistory(int comic_id){
    return prefs.getInt("comic$comic_id") ?? 0;
  }
  static void setComicHistory(int comic_id,int value){
    prefs.setInt("comic$comic_id", value);
  }
 /// 漫画阅读方向
  ...
  /// 小说阅读记录
  static int getNovelHistory(int novel_id){
    return prefs.getInt("novel$novel_id") ?? 0;
  }
  static void setNovelHistory(int novel_id,int value){
    prefs.setInt("novel$novel_id", value);
  }
